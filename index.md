...
<section class="hero">
  <div class="wrap hero-grid">
    ...
    <div class="hero-image"><img src="{{ '/assets/photography/hero.png' | relative_url }}" alt="Bright residential interior with practical property details" width="1600" height="1200"></div>
  </div>
</section>
